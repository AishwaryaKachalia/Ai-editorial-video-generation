...
export const mosaicExampleScenes: MosaicScene[] = [
  {id: 'black-turtleneck', src: 'images/black-turtleneck-full.jpg', durationInFrames: 90, revealDuration: 66, pattern: 'reading-order'},
  ...
  {id: 'logo', src: 'images/logo-embossed-card.jpg', durationInFrames: 90, revealDuration: 66, pattern: 'reading-order'},
];
